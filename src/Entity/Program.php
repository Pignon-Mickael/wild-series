...
class Program
{
     ...
     * @Assert\Length(max="255", maxMessage="le titre saisi {{ value }} et trop long, il ne devrait pas dépasser {{ limit }} caractères")
     */
    private $title;

    /**
     * @ORM\Column(type="text")
     * @Assert\NotBlank(message="Veuillez ajouter un résumé")
     * @Assert\Regex(
