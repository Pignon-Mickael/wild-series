...
class Slugify
{
//    public const LETTER_ERROR =
//        [
//            'À', 'Á', 'Â', 'Ã', 'Ä', 'Å', 'Æ', 'Ç', 'È', 'É', 'Ê', 'Ë', 'Ì', 'Í', 'Î', 'Ï', 'Ð',
//            'Ñ', 'Ò', 'Ó', 'Ô', 'Õ', 'Ö', 'Ø', 'Ù', 'Ú', 'Û', 'Ü', 'Ý', 'ß', 'à', 'á', 'â', 'ã',
//            'ä', 'å', 'æ', 'ç', 'è', 'ê', 'ë', 'ì', 'í', 'î', 'ï', 'ñ', 'ò', 'ó', 'ô', 'õ', 'é',
...
//    {
//        $input = str_replace(self::LETTER_ERROR, self::LETTER_VALID, trim(strtolower($input)));
//        $input = preg_replace(array('/[^a-zA-Z0-9 -]/', '/[ -]+/', '/^-|-$/'), array('', '-', ''), $input);
//        return trim($input, '-');
//    }
    ...
    public function generate(string $input): string
    {
        ...
        $input = str_replace($a, $b, trim(strtolower($input)));
